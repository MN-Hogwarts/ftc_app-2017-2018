...
public class SWGamePad implements TrcTaskMgr.Task {
    private static final String moduleName = "SWGamePad";
    private static boolean debugEnabled = true;
    private static final boolean tracingEnabled = false;
    private static final TrcDbgTrace.TraceLevel traceLevel = TrcDbgTrace.TraceLevel.API;
    private static final TrcDbgTrace.MsgLevel msgLevel = TrcDbgTrace.MsgLevel.VERBOSE;
    ...
    public interface ButtonHandler
    {
         ...
         */
        void gamepadButtonEvent(SWGamePad gamepad, int button, boolean pressed);
     ...
     *                      null.
     */
    public SWGamePad(final String instanceName, Gamepad gamepad, ButtonHandler buttonHandler)
    {
     ...
     * @param gamepad specifies the gamepad associated with this instance.
     */
    public SWGamePad(final String instanceName, Gamepad gamepad)
    {
     ...
     * @param deadbandThreshold specifies the deadband of the gamepad analog sticks.
     */
    public SWGamePad(final String instanceName, Gamepad gamepad, final double deadbandThreshold)
    {
    ...
    public void enableDebug(boolean debugEnabled){
        SWGamePad.debugEnabled = debugEnabled;
    }

    public boolean isDebugEnabled(){
        return SWGamePad.debugEnabled;
    }
     ...
     */
    public double getLeftStickDirectionRadians(boolean squared, boolean setYAxisAsZero)
    {
        final String funcName = "getLeftStickDirectionRadians";
        double x = getLeftStickX(squared);
        double y = getLeftStickY(squared);

        if(setYAxisAsZero){
            y = getLeftStickX(squared);
            x = getLeftStickY(squared);
        }
    ...
    {
        return getLeftStickDirectionRadians(false, false);
    }   //getLeftStickDirectionRadians
     ...
     */
    public double getRightStickDirectionRadians(boolean squared, boolean setYAxisAsZero)
    {
    ...
    {
        return getRightStickDirectionRadians(false, false);
     ...
     */
    public double getLeftStickDirectionDegrees(boolean squared, boolean setYAxisAsZero)
    {
        return Math.toDegrees(getLeftStickDirectionRadians(squared, setYAxisAsZero));
    ...
    {
        return getLeftStickDirectionDegrees(false, false);
    }   //getLeftStickDirectionDegrees

    public double getLeftStickDirectionDegrees(boolean setYAxisAsZero)
    {
        return getLeftStickDirectionDegrees(false, setYAxisAsZero);
    }   //getLeftStickDirectionDegrees
     ...
     */
    public double getRightStickDirectionDegrees(boolean squared, boolean setYAxisAsZero)
    {
        return Math.toDegrees(getRightStickDirectionRadians(squared, setYAxisAsZero));
    ...
    {
        return getRightStickDirectionDegrees(false, false);
    }   //getRightStickDirectionDegrees

    public double getRightStickDirectionDegrees(boolean setYAxisAsZero)
    {
        return getRightStickDirectionDegrees(false, setYAxisAsZero);
    }   //getRightStickDirectionDegrees
    ...
    {
        //do the ssame thing as the prePeriodicTask
        prePeriodicTask(runMode);
    }   //preContinuousTask
